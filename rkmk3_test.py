...
def RKMK2(steps, kinematics):
    ...
    for i in range(steps):
        ...
        a2_1 = 0.5
        Theta2 = a2_1*F1
        theta = h*kinematics(T*SE3.from_vec(Theta2), time+c2*h)
...
if __name__ == '__main__':
    ...
    RKMK1_steps2 = 1000
    RKMK2_steps = 20
    RKMK_euler(RKMK1_steps1, kinematics)
    RKMK_euler(RKMK1_steps2, kinematics)
    RKMK2(RKMK2_steps, kinematics)
    plt.legend([f'RKMK1 {RKMK1_steps1} steps', f'RKMK1 {RKMK1_steps2} steps', f'RKMK2 {RKMK2_steps} steps'])
    plt.show()
